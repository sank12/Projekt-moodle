...
<?php
    ...
    if(isset($_GET['dolacz']) && $_GET['dolacz']=="tak")
    {
        ...
        if ($ilosc_wierszy !=0) 
        {
            ...
            header("Location: ../Uczen/lista.php?id={$_GET['id_kursu']}&dodano=nalezysz");
            return;
        }
        ...
        header("Location: ../Uczen/lista.php?id={$_GET['id_kursu']}&dodano=tak");
        return;
    }
    ...
    {   
        ...
        {   
            ...
            if(mysql_num_rows($wynik) == 1) 
            {
                ...
                echo '<a href="dolacz.php?v=tresc/u_kursy/dolacz_do_kursu&wyslano=tak&dolacz=tak&id_kursu='.$id.'" type="button" class="btn btn-success" style="margin-right: 20px; margin-left: 20px;">Tak (dołącz)</a>';
                echo '<a href="dolacz.php?v=tresc/u_kursy/lista_kursow_uzytkownika" type="button" class="btn btn-default">Nie (powrót)</a> ';
