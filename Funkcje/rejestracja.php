...
<div class="row">
        ...
        <form action="?v=tresc/rejestracja/rejestracja" id="rejestracja" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
                <input type="password" id="r_haslo" class="form-control" name="r_haslo1" placeholder="Haslo" >
            </div>
            <div class="form-group">
                 <input type="password" id="r_haslo2" class="form-control" name="r_haslo2" placeholder="Powtorz haslo">
            </div>
            <div class="form-group">
                <input type="email" id="email" class="form-control" name="r_email" placeholder="Email" value="<?=@$_POST['email']?>">
            </div>
            <div class="form-group">
                <input type="text" id="imie" class="form-control" name="r_imie" placeholder="Imie" value="<?=@$_POST['imie']?>">
            </div>
            <div class="form-group">
