...
<html>
 ...
 <?php 
  ...
  <div class="controls"><input type="text" class="form-control"></div>
  </div>
  <div class="form-group">
  <label class="control-label">Hsalo</label>
  <div class="controls"><input type="text" class="form-control"></div>
</div>

          <div id='l_button_lewy'><button type="submit" name="submit" class="btn btn-info btn-block ">Zaloguj</button></div>
          
            <div id='l_button_prawy'><button type="button" name="przypomnij" class="btn  btn-block">Przypomnij haslo</button></div>
        </div>
        <div class="col-md-6">
